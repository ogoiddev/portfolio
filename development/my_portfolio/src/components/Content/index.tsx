...
function Content() {
    ...
    return (
        <Container>
            ...
            <h1 className="tile-contact">
            ___________________
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send-plus-fill" viewBox="0 0 16 16">
            ...
            <div className="contact">
                ...
                <form
                    id='myForm'
                    action="https://formsubmit.co/ogoiddev@gmail.com"
                    method="POST"
                    className="form"
                >
                        
                        <input type="hidden" name="_next" value="http://127.0.0.1:3000/home"></input>
